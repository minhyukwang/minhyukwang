...
<img src="https://readme-typing-svg.vercel.app/?lines=👋+안녕하세요,+민혁입니다;💻+풀스택+개발자;🚀+혁신적인+웹+애플리케이션을+만듭니다&font=Fira%20Code&center=true&width=600&height=50&color=58A6FF&vCenter=true&size=24&duration=3000&pause=1000">
...
풀스택 개발자로서 웹 애플리케이션 개발에 열정을 가지고 있습니다.  
엔터프라이즈급 시스템부터 스타트업 프로젝트까지 다양한 경험을 보유하고 있습니다.
...
<details>
<summary><b>주요 엔터프라이즈 프로젝트 보기</b></summary>

- **NH농협 차세대경제시스템 개발**  
  NH Nonghyup Enterprise Economy System  
  대규모 금융 시스템 개발 및 유지보수

- **POSCO MES 노재내화물 관리 개발**  
  POSCO MES Refractories Management  
  제조 실행 시스템 내 내화물 관리 모듈 개발

- **POSCO 전사 제안관리시스템 개발**  
  POSCO Enterprise Proposal Management  
  전사 차원의 제안 관리 플랫폼 구축

- **POSCO MES 철도관제시스템 개발**  
  POSCO MES Railway Management  
  철도 운행 및 관제 시스템 개발

- **POSCO Smart Factory Posframe Platform 개발**  
  POSCO Smartfactory Posframe Platform  
  스마트 팩토리 플랫폼 개발 및 통합

</details>

### 🚀 ThinkingCat Works 프로젝트

[thinkingcatworks.com](https://thinkingcatworks.com)에서 개발한 프로젝트들:
